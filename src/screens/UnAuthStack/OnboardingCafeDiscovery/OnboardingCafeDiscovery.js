...
const OnboardingCafeDiscovery = ({ navigation, route }) => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1: return <Workability onNext={goNext} mode={mode} />
      case 2: return <CafeeFood onNext={goNext} mode={mode} />
      case 3: return <AccessibilityValue onNext={goNext} mode={mode} />
      case 4: return <ComfortEnvirment onNext={goNext} mode={mode} />
      case 5: return <AstheticVibe onNext={goNext} mode={mode} />
      case 6: return <SubmitScreen onNext={goNext} mode={mode} />
      default: return null
    }
  }
